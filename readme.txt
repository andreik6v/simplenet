...
= 1.8.1 - 01/13/26 =
* added a gradient background to the framed style
...
* added search block style (underline)
* added details block style (plus-minus)
...
* changed border color for fields
* changed outline width for active fields

= 1.7.1 - 09/02/25 =
* removed buttons transitions
* increased padding for sticky blocks
...
Simplenet WordPress Theme, (C) 2024 Andrei Chira
...
Icons available from Heroicons with MIT license.
