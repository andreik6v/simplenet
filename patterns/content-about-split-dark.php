 ...
 * Slug: henry/content-about-split-dark
 * Categories: content
 */
?>
...
<div class="wp-block-group alignfull has-base-color has-contrast-background-color has-text-color has-background" style="margin-top:0;padding-top:var(--wp--preset--spacing--x-large);padding-right:30px;padding-bottom:var(--wp--preset--spacing--x-large);padding-left:30px">
	...
	<div class="wp-block-columns alignwide are-vertically-aligned-top" style="margin-top:var(--wp--preset--spacing--x-small)">
		...
		<div class="wp-block-column is-vertically-aligned-top"><!-- wp:heading {"style":{"typography":{"fontStyle":"normal","fontWeight":"300","letterSpacing":"-1px"}},"fontSize":"max-48"} -->
			<h2 class="wp-block-heading has-max-48-font-size" style="font-style:normal;font-weight:300;letter-spacing:-1px"><?php echo esc_html__( 'Are you ready to start designing with WordPress?', 'henry' ); ?></h2>
			<!-- /wp:heading -->
			<!-- wp:buttons -->
		...
		<div class="wp-block-column is-vertically-aligned-top">
			<!-- wp:paragraph -->
			<p><?php echo esc_html__( 'We want to revolutionize how beautiful WordPress websites are made by embracing the power and flexibility of block-based design. Our approach transcends conventional standards and provides an innovative and imaginative canvas where creativity has no limits.', 'henry' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
	</div>
