 ...
 * Slug: henry/testimonials-single-dark
...
<div class="wp-block-group alignfull has-base-color has-contrast-background-color has-text-color has-background has-link-color" style="padding-top:var(--wp--preset--spacing--x-large);padding-right:30px;padding-bottom:var(--wp--preset--spacing--x-large);padding-left:30px">
	...
	<p class="has-text-align-center has-large-font-size" style="margin-top:10px;line-height:1.5"><?php echo esc_html__( '“Propelled by true innovation and style, Powder is a block-based WordPress theme that makes building websites a breeze.”', 'henry' ); ?></p>
	<!-- /wp:paragraph -->
	...
	<div class="wp-block-group">
		...
		<p class="has-small-font-size"><?php echo esc_html__( 'Jennifer Kayne, Designer', 'henry' ); ?></p>
		<!-- /wp:paragraph -->
	</div>
	<!-- /wp:group -->
</div>
