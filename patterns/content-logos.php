...
<div class="wp-block-group alignfull" style="margin-top:0;padding-top:var(--wp--preset--spacing--x-large);padding-right:30px;padding-bottom:var(--wp--preset--spacing--x-large);padding-left:30px">
	...
	<h2 class="wp-block-heading has-text-align-center has-small-font-size" style="margin-bottom:var(--wp--preset--spacing--small);text-transform:uppercase"><?php echo esc_html__( 'Our Clients', 'henry' ); ?></h2>
	<!-- /wp:heading -->
