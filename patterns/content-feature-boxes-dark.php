 ...
 * Slug: henry/content-feature-boxes-dark
 * Categories: content
 */
?>
...
<div class="wp-block-group alignfull has-base-color has-contrast-background-color has-text-color has-background" style="margin-top:0;padding-top:var(--wp--preset--spacing--x-large);padding-right:30px;padding-bottom:var(--wp--preset--spacing--x-large);padding-left:30px">
	...
	<h1 class="wp-block-heading has-text-align-center has-max-48-font-size" style="line-height:1"><?php echo esc_html__( 'Choose Powder.', 'henry' ); ?></h1>
	<!-- /wp:heading -->
	<!-- wp:paragraph {"align":"center","style":{"spacing":{"margin":{"top":"10px","bottom":"var:preset|spacing|small"}}}} -->
	<p class="has-text-align-center" style="margin-top:10px;margin-bottom:var(--wp--preset--spacing--small)"><?php echo esc_html__( 'Redefine your space with a stylish, modern design.', 'henry' ); ?></p>
	<!-- /wp:paragraph -->
	...
	<div class="wp-block-columns alignwide">
		...
		<div class="wp-block-column has-border-color" style="border-color:#262626;border-width:1px;padding-top:var(--wp--preset--spacing--medium);padding-right:var(--wp--preset--spacing--small);padding-bottom:var(--wp--preset--spacing--medium);padding-left:var(--wp--preset--spacing--small)">
			...
			<h2 class="wp-block-heading has-text-align-center has-x-small-font-size" style="text-transform:uppercase"><?php echo esc_html__( 'Feature Headline', 'henry' ); ?></h2>
			<!-- /wp:heading -->
			<!-- wp:paragraph {"align":"center","fontSize":"small"} -->
			<p class="has-text-align-center has-small-font-size"><?php echo esc_html__( 'Design beautiful WordPress websites with the stylish Powder theme.', 'henry' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
		<!-- wp:column {"style":{"border":{"color":"#262626","width":"1px"},"spacing":{"padding":{"top":"var:preset|spacing|medium","bottom":"var:preset|spacing|medium","left":"var:preset|spacing|small","right":"var:preset|spacing|small"},"blockGap":"var:preset|spacing|x-small"}}} -->
